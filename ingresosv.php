...
<div id="cuerpo" style="display: <?php print $lbv ?>";>
    ...
    <form method="POST" action="ingresos.php?Id=<?php print $id_exp ?>" autocomplete="off"> 
        ...
        <table border="2" >
            <tr colspan="2">
                <th  colspan="2" style="border-bottom-style: solid;"><h3>Sin Datos</h3></th>
            </tr>
...

{
    ...
    .'<td>'.$p3.'</td>'
    .'<td style="width:10%">
    <a href="visualizar_ficha.php">Principal</a>
    </td>'
               ...
               <tr>
                <th colspan="1" style="width: 30%;"><b>N° de Componente</b><br>
                    ...
                    <th colspan="1"><b>Cobró por¿Cuántos beneficios?</b><br>
                        <input type="text" name="c2" id="c2" readonly onkeydown="return tab_btn4(event,getElementById('c2'),getElementById('c3'))" class="entero" onkeypress="return check(event,value)" oninput="checkLength200()" value="<?php print $c2 ?>" <?php print $clap1 ?>></th>
                    <th colspan="1"><b>Monto cobrado</b><br><input type="text" name="c3" id="c3" class="entero" onkeypress="return check(event,value)" onkeydown="return tab_btn4(event,getElementById('c3'),getElementById('submitguardara'))" readonly oninput="checkLength300()" value="<?php print $c3 ?>" disabled></th>
                </tr>
...
while ($row=  pg_fetch_array($Nuevocompo)) // recorre los identificaciones uno por uno hasta el fin de la tabla
{
 include './ifcomponente.php';
    ...
    .'<td style="width:10%"><a href="ingresosv.php?Id='.$row['id_exp'].'&mio='.$row['id_cmpt'].'">Visualizar</a></td>'
    ...
    if(c.value == "2" || c.value=="99" )
    {
        ...
        {   
            ...
            if(ms.value=="99"){
                ...
                if(l.value=="99" ||l.value=="1" || l.value=="2" || l.value=="3" || l.value=="4" || l.value=="5" || l.value=="6" || l.value=="7" || l.value=="8" || l.value=="9" || l.value=="10" || l.value=="11" || l.value=="12" || l.value=="13" || l.value=="14" || l.value=="15" ||  l.value=="16" || l.value=="17" )
                {
   ...
   function tab_btn2(event,p1,p2,p3)
{
  ...
  if (t == 9 && (x1.value <= 17 || x1.value=='99')) 
  {
