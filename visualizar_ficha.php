...
<form method="POST" action="visualizar_ficha.php" autocomplete="off">
    ...
    <tr>
        ...
        <th style="text-align: :justify">Número de Ficha<input type="number" id="nro_exp" name="nro_exp" class="numero" min="1" max="99999" align="right" value = "<?php print $id_exp ?>" tabindex="1" id="nro_exp" <?php print $s ?> onkeypress="return check(event,value)" oninput="checkLength1()" readonly ></th>
    </tr>
    <tr>
        <th></th>
